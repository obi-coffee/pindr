-- Phase 5b: extend discover_candidates so the swipe card can badge hosts
-- with an active upcoming round. Adds three nullable columns
-- (upcoming_round_id, tee_time, course_name). Everything else matches the
-- 20260420090000 version; rebuild with the new shape.
